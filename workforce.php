            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="fact-item bg-light rounded text-center h-100 p-1">
                        ...
                        <h2 class="display-6 mb-0" data-toggle="counter-up">52658</h2>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="fact-item bg-light rounded text-center h-100 p-1">
                        ...
                        <h2 class="display-6 mb-0" data-toggle="counter-up">1187</h2>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="fact-item bg-light rounded text-center h-100 p-1">
                        <i class="far fa-money-bill-alt fa-4x maincolor mb-4"></i>
                        <h5 class="mb-3">Earnings</h5>
                        <h2 class="display-6 mb-0" data-toggle="counter-up">41548151</h2>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="fact-item bg-light rounded text-center h-100 p-1">
                        ...
                        <h2 class="display-6 mb-0" data-toggle="counter-up">2137982</h2>
                    </div>
                </div>
            </div>
        </div>

        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1">
                    <img class="img-fluid" src="assets/img/slider1ani.png" alt="Image">
                </button>
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="1" aria-label="Slide 2">
                    <img class="img-fluid" src="assets/img/slider550-2.png" alt="Image">
                </button>
                <button type="button" data-bs-target="#header-carousel" data-bs-slide-to="2" aria-label="Slide 3">
                    <img class="img-fluid" src="assets/img/slider550-3.png" alt="Image">
                </button>
            </div>
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="assets/img/slider550-2.png" alt="Task Fulfilment">
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="assets/img/slider550-3.png" alt="Work From Anywhere">
                    <div class="carousel-caption">
                        <div class="p-3" style="max-width: 900px;">
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        <h6 class="section-title bg-white text-start maincolor pe-3">We Are</h6>
            ...
            <div class="container">
                ...
                <div class="row g-4 wow fadeInUp mt-2" data-wow-delay="0.7s">
                    ...
                    <div class="col-lg-4">
                        ...
                        <ul>
                            <li>Knowledge based video</li>
                            <li>Instagram Posts and Reels</li>
                            <li>Facebook Post and Status</li>
                            <li>Featured Ads on News Website</li>
                            <li>Text and WhatsApp Messaging</li>
                        </ul>
                    </div>
                    <div class="col-lg-4">
                        <div class="work" style="border: 1px solid white ; border-radius: 10px; box-shadow: 0px 0px 10px grey;">
                        ...
                        <ul>
                            ...
                            <li>Social media creative and content</li>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        ...
                        <h2 class="display-5 mb-0" data-toggle="counter-up">1187</h2>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="fact-item bg-light rounded text-center h-100 p-5">
                        ...
                        <h2 class="display-5 mb-0" data-toggle="counter-up">2137982</h2>
                    </div>
                </div>
            </div>
        </div>
